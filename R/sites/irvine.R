...
# one gap-free record back to 1915 — the same predecessor/successor idea as
...
SITE <- list(
  ...
  local_rationale = paste(
    ...
    "a much shorter record than the reference series. The reference series, labelled “Irvine”,",
    "splices the Irvine Ranch COOP station's original site (049087, “Tustin Irvine Ranch”,",
    "1915–2003) with its direct successor a few miles away (044303, 2003–2026) for one",
    "gap-free record back to 1915; the two stations' own records do not quite touch (049087",
    "ends June 2003, 044303 begins August 2003), which costs 2003 its “complete year” status."
  ),
